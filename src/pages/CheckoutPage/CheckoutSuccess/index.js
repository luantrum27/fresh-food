...
function CheckoutPageSuccess() {
    ...
    information.current = location.state || {
        ...accounts[0],
        customerName: 'Admin',
        delivery_address: '123 Nguyễn Minh Châu, Phường Hòa Hải, Quận Ngũ Hành Sơn, Tp Đà Nẵng',
        payments: 'Chuyển khoản'
    };
    return (
        <div className={cx('CheckoutPageSuccess')}>
            <div className={cx(['CheckoutPageSuccess__container', 'container'])}>
                ...
                <div className={cx('section__main')}>
